...
Route::post('receice-batches/{id}','BatchesController@receiceBatches');
Route::post('receive-serials/{id}','BatchesController@receiveSerials');
Route::get('show-lines/{id}','BatchesController@showBatches');
Route::get('show-lines-b/{id}','BatchesController@showBatchesBal');
Route::resource('approved-pos','ApprovedPurchaseOrdersController');
Route::get('approved-po/{id}','ApprovedPurchaseOrdersController@approvePO');
Route::get('approve-all-pos/{id}','ApprovedPurchaseOrdersController@approveAll');
Route::get('approve-all-pos-b/{id}','ApprovedPurchaseOrdersController@approveAllBal');
...
Route::get('check-po-status_2/{id}','ApprovedPurchaseOrdersController@poStatus_2');
